      ...
      <section className="py-24 bg-gradient-to-b from-blue-950 to-blue-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <h3 className="text-xl font-medium text-gray-300 mb-6">Trusted by innovative companies worldwide</h3>
            <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-80">
              <div className="h-7 w-auto">
                <svg viewBox="0 0 124 24" fill="currentColor" className="h-full w-auto text-gray-300">
